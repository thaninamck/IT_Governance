...
const MyProfile = () => {
  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-wrap sm:min-h-screen  bg-gray-100">
        {/* Barre latérale */}
        <div className="">
          <SideBar />
        </div>
        ...
        {/* Contenu principal */}
        <div className="bg-white min-h-screen  overflow-auto  flex-1  items-center justify-center p-6   rounded-lg">
          <div className=" flex flex-col gap-40  items-center justify-between">
            <div className="sm:relative sm:w-full self-center">
              <HeaderBis className="" />
            </div>

            <div className=" info-profile flex flex-col  gap-60 sm:flex sm:relative sm:flex-row sm:gap-x-96  ">
