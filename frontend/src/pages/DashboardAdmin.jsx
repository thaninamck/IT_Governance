                ...
                >
                    ...
                    {/* <div className="flex gap-4 my-4">
                        <button
                            onClick={handlePrev}
                            disabled={currentPage === 0}
                            className="px-5 py-2  border-none bg-white text-gray-700 border border-gray-300 shadow-sm transition-all duration-200 hover:bg-gray-100 hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-400"
                        >
                            ◀ Précédent
                        </button>
                        <button
                            onClick={handleNext}
                            disabled={currentPage === totalPages - 1}
                            className="px-5 py-2  border-none bg-blue-600 text-white shadow-sm transition-all duration-200 hover:bg-blue-700 hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-400"
                        >
                            Suivant ▶
                        </button>
                    </div> */}
