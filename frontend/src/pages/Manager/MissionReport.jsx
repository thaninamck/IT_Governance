  ...
  return (
    ...
    location.pathname.startsWith(route)
      ...
      <div className="flex mt-16 flex-col lg:flex-row lg:justify-between lg:items-center lg:items-start gap-6 w-full px-4">
        ...
        <div className="w-full max-h-80 overflow-y-auto p-1 rounded-lg ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 mx-4 mt-24 mb-4">
        ...
        <div className="bg-white shadow-md rounded-lg p-4">
          <h2 className="text-center font-bold">Score de conformité par Systèmes d'exploitation</h2>
          <ResponsiveContainer width="90%" height={250}>
        ...
        {/* Graphique Système */}
        <div className="bg-white shadow-md rounded-lg p-4">
          <h2 className="text-center font-bold">Score de conformité global par système</h2>
          <ResponsiveContainer width="90%" height={250}>
        ...
        {/* Graphique Couhe */}
        <div className="bg-white shadow-md rounded-lg p-4">
          <h2 className="text-center font-bold">Score de conformité global par couche</h2>
          <ResponsiveContainer width="90%" height={250}>
