...
function MissionCards({ data, size = 'medium' }) {
    ...
    const pourcentageControlFinalisé = Math.round((data?.controlCommencé?.nbrFinalisé / data?.controlCommencé?.nbrTotale) * 100) || 0;
    const pourcentageControlNonFinalisé = Math.round((data?.controlCommencé?.nbrNonFinalisé / data?.controlCommencé?.nbrTotale) * 100) || 0;
    ...
    const statusControlDataPerIneff = [

        {
            ...
            pourcentage: `${data?.controlNonEffective?.nbrPartiallyPerIneff}`,
        },
        {
            id: "2",
            nom: "Not applied",
            pourcentage: `${data?.controlNonEffective?.notAppPerIneff}`,
        },
        {
            id: "3",
            nom: "Not tested",
            pourcentage: `${data?.controlNonEffective?.notTestedPerIneff}`,
        },
        {
            id: "4",
            nom: "Not applicable",
            pourcentage: `${data?.controlNonEffective?.notApplicablePerIneff}`,
        },
    ];
